/*
 Trek-The Guide v1.6 Arexx Front End
...
call openscreen(0, 4, hireslace, 'Trek-The.Guide v1.6 ©1994-1995 Jim Hines', trekguide,, width, height, 0)
/* why the hell does does it look for the rexxreqtools.library for the arp openscreen call??????? */
...
if exists('envarc:TrekGuide') then do
	...
	call PostMsg(0, 0,'Loading previously saved episode list.', TREKGUIDE)
	end
