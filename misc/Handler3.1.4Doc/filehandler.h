...
/*
**	$Id: filehandler.h,v 1.1 2001-07-08 10:41:43 olsen Exp $
**
...
#define ENVF_SUPERFLOPPY (1L << 17)   /* Request device geometry by TD_GETGEOMETRY or HD_SCSICMD, DE_LOWCYL must be 0 */
