...
80     CLOCK 1
90    N=139 :  GOSUB 9000
91    N=48+23 :  GOSUB 9100
92    N=140 :  GOSUB 9000
93    N=48+53 :  GOSUB 9100
94    N=141 :  GOSUB 9000
95    N=48+50 :  GOSUB 9100
96    N=142 :  GOSUB 9000
97    N=46 :  GOSUB 9100
100    REM
110   CHAR=GET
...
9290   RETURN 
10000  REM
10020  IF X=31 THEN E=1
10030  IF X=159 THEN E=2
10040  IF X=95 THEN E=3
10050  IF X=223 THEN E=4
10060  IF X=63 THEN E=5
10070  IF X=191 THEN E=6
10080  IF X=127 THEN E=7
10090  IF X=255 THEN E=8
10100 N=143 :  GOSUB 9000
10110 N=48+E :  GOSUB 9100
10190 X=X+32
10195  IF X>255 THEN X=31
10200  RETURN 
